      ...
      <div className="max-w-7xl mx-auto px-6 pt-32">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            >
              I use most of Javascript, Typescript.
              <br />
              And some of popular framework like ReactJS, NextJs.
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div
               ...
               to-tertiary/10 opacity-0 group-hover:opacity-100 transition-opacity"
              />
            </motion.button>
          </motion.div>
          ...
          >
            <div className="relative w-full aspect-square group">
              ...
              <motion.div
               ...
               overflow-hidden border border-white/10 bg-surface backdrop-blur-sm"
              >
                <Image
                  src="/nxq.jpg"
                  alt="Avatar"
